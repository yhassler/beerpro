...
public class FridgeActivity extends AppCompatActivity implements OnFridgeContentItemInteractionListener {
    ...
    private void updateFridge(List<Pair<FridgeContent, Beer>> entries) {
